...
<head>
    ...
    <?php 
		$title = $text->daily_revenue_by_department;
    ...
    <div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><?php echo $text->daily_revenue_by_department; ?></li>
			</ol>
		</div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><?php echo $text->daily_revenue_by_department; ?></h2>
            </div>
        </div>
        <div class="row" >
            <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <ul class="printed_pagination pagination">
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$(".update").on("click", function(event){
				...
				$.ajax({
					url: "../system/finances/TodayRevenueByDepartment.ajax.php",
					type: "POST",
        ...
        scrollTop: $("#main_board").offset().top
            ...
            $(".registrations_more").on("click", function(){
               ...
               $.ajax({
					url: "../system/finances/registrations.ajax.php",
					type: "POST",
					data: { department: department, date: date},
					dataType: "json"
				}).always(function(){
        ...
        scrollTop: $("#registrations_names").offset().top
            ...
            $(".view_fines_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/finances/fines.ajax.php",
					type: "POST",
					data: { department: department, date: date},
					dataType: "json"
				}).always(function(){
        ...
        scrollTop: $("#fined_names").offset().top
            ...
            $("#pdf_fined").on("click", function(){
               ...
               window.open('finedToPDF.php?department='+department+'&date='+date+"&departmentText="+departmentText);
            ...
            $(".view_reservations_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/finances/reservations.ajax.php",
					type: "POST",
					data: { department: department, date: date},
					dataType: "json"
				}).always(function(){
        ...
        scrollTop: $("#reservationed_names").offset().top
            ...
            $(".view_prints_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/finances/prints.ajax.php",
					type: "POST",
					data: { department: department, date: date},
					dataType: "json"
				}).always(function(){
        ...
        scrollTop: $("#printed_names").offset().top
            ...
            $("#pdf_printed").on("click", function(){
               ...
               window.open('printedToPDF.php?department='+department+'&date='+date+"&departmentText="+departmentText);
            ...
            $(".view_others_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/finances/others.ajax.php",
					type: "POST",
					data: { department: department, date: date},
					dataType: "json"
				}).always(function(){
        ...
        scrollTop: $("#othered_names").offset().top
            ...
            $("#pdf_othered").on("click", function(){
               ...
               window.open('otheredToPDF.php?department='+department+'&date='+date+"&departmentText="+departmentText);
             ...
             $("#pdf_daily").on("click", function(){
               ...
               window.open('dailyPDF.php?department='+department+'&date='+date+"&departmentText="+departmentText+"&total="+total+"&registrations="+registrations+"&fines="+fines+"&reservations="+reservations+"&prints="+prints+"&others="+others);
