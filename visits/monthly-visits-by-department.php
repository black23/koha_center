...
<body>
    ...
    <div class="container">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><?php echo $text->monthly_visits; ?></li>
			</ol>
		</div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><?php echo $text->monthly_visits; ?></h2>
            </div>
        </div>
        <div class="row" >
            <div class="col-md-12">
    ...
    $( "#to" ).datepicker('setDate', "<?php echo $defaultTo; ?>");
			...
			$(".update").on("click", function(event){
				...
				$.ajax({
					url: "../system/visits/MonthlyVisitsByDepartment.ajax.php",
					type: "POST",
        ...
        scrollTop: $("#main_board").offset().top
            ...
            $(".view_registrations_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/visits/monthly_registrations.ajax.php",
					type: "POST",
					data: { department: department, from: from, to: to},
					dataType: "json"
				}).always(function(){
            ...
            var addRegistered = function(results){
                ...
                if (number_of_registered_users <= 10) {
                    $.each(rows, function(i, item) {
                        $('.registered').find('tbody:last').append("<tr><td>"+rows[i].firstname+"</td><td>"+rows[i].surname+"</td><td>"+rows[i].datetime+"</td><td><a href='../../cgi-bin/koha/members/boraccount.pl?borrowernumber="+rows[i].borrowernumber+"' target='_blank'><i class='fa fa-external-link'></i></a></td></tr>");
                    });
                }
                else {
                    // print 10
        ...
        scrollTop: $("#registrations_names").offset().top
            ...
            $(".view_borrows_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/visits/monthly_borrows.ajax.php",
					type: "POST",
					data: { department: department, from: from, to: to},
					dataType: "json"
				}).always(function(){
            ...
            var addBorrows = function(results){
                ...
                if (number_of_borrowed_users <= 10) {
                    $.each(rows, function(i, item) {
                        $('.borrowed').find('tbody:last').append("<tr><td>"+rows[i].firstname+"</td><td>"+rows[i].surname+"</td><td>"+moneyFormat(rows[i].count)+"</td><td>"+rows[i].datetime+"</td><td><a href='../../cgi-bin/koha/members/boraccount.pl?borrowernumber="+rows[i].borrowernumber+"' target='_blank'><i class='fa fa-external-link'></i></a></td></tr>");
                    });
                }
                else {
                    // print 10
        ...
        scrollTop: $("#borrowed_names").offset().top
            ...
            $("#pdf_borrowed").on("click", function(){
               ...
               window.open('monthlyBorrowedToPDF.php?department='+department+'&from='+from+'&to='+to+"&departmentText="+departmentText);
            ...
            $(".view_reservations_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/visits/monthly_reservations.ajax.php",
					type: "POST",
					data: { department: department, from: from, to: to},
					dataType: "json"
				}).always(function(){
            ...
            var addReservations = function(results){
                ...
                if (number_of_reservationed_users <= 10) {
                    $.each(rows, function(i, item) {
                        $('.reservationed').find('tbody:last').append("<tr><td>"+rows[i].firstname+"</td><td>"+rows[i].surname+"</td><td>"+moneyFormat(rows[i].count)+"</td><td>"+rows[i].datetime+"</td><td><a href='../../cgi-bin/koha/members/boraccount.pl?borrowernumber="+rows[i].borrowernumber+"' target='_blank'><i class='fa fa-external-link'></i></a></td></tr>");
                    });
                }
                else {
                    // print 10
        ...
        scrollTop: $("#reservationed_names").offset().top
            ...
            $(".view_virtualReservations_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/visits/monthlyVirtualReservations.ajax.php",
					type: "POST",
					data: { department: department, from: from, to: to},
					dataType: "json"
				}).always(function(){
            ...
            var addVirtualReservations = function(results){
                ...
                if (number_of_virtualReservationed_users <= 10) {
                    $.each(rows, function(i, item) {
                        $('.virtualReservationed').find('tbody:last').append("<tr><td>"+rows[i].firstname+"</td><td>"+rows[i].surname+"</td><td>"+moneyFormat(rows[i].count)+"</td><td>"+rows[i].datetime+"</td><td><a href='../../cgi-bin/koha/members/boraccount.pl?borrowernumber="+rows[i].borrowernumber+"' target='_blank'><i class='fa fa-external-link'></i></a></td></tr>");
                    });
                }
                else {
                    // print 10
        ...
        scrollTop: $("#virtualReservationed_names").offset().top
            ...
            $("#pdf_virtualReservationed").on("click", function(){
               ...
               window.open('monthlyVirtualReservationedToPDF.php?department='+department+'&from='+from+'&to='+to+"&departmentText="+departmentText);
               
            });
            
             /* VirtualReservations END */
            ...
            $(".view_returns_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/visits/monthly_returns.ajax.php",
					type: "POST",
					data: { department: department, from: from, to: to},
					dataType: "json"
				}).always(function(){
            ...
            var addReturns = function(results){
               ...
               if (number_of_returned_users <= 10) {
                    $.each(rows, function(i, item) {
                        $('.returned').find('tbody:last').append("<tr><td>"+rows[i].firstname+"</td><td>"+rows[i].surname+"</td><td>"+moneyFormat(rows[i].count)+"</td><td>"+rows[i].datetime+"</td><td><a href='../../cgi-bin/koha/members/boraccount.pl?borrowernumber="+rows[i].borrowernumber+"' target='_blank'><i class='fa fa-external-link'></i></a></td></tr>");
                    });
                }
                else {
                    // print 10
        ...
        scrollTop: $("#returned_names").offset().top
            ...
            $("#pdf_returned").on("click", function(){
               ...
               window.open('monthlyReturnedToPDF.php?department='+department+'&from='+from+'&to='+to+"&departmentText="+departmentText);
            ...
            $(".view_paids_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/visits/monthly_paids.ajax.php",
					type: "POST",
					data: { department: department, from: from, to: to},
					dataType: "json"
				}).always(function(){
            ...
            var addPaids = function(results){
                ...
                if (number_of_paid_users <= 10) {
                    $.each(rows, function(i, item) {
                        $('.paid').find('tbody:last').append("<tr><td>"+rows[i].firstname+"</td><td>"+rows[i].surname+"</td><td>"+rows[i].datetime+"</td><td><a href='../../cgi-bin/koha/members/boraccount.pl?borrowernumber="+rows[i].borrowernumber+"' target='_blank'><i class='fa fa-external-link'></i></a></td><td>"+rows[i].accounttype+"</td></tr>");
                    });
                }
                else {
                    // print 10
        ...
        scrollTop: $("#paid_names").offset().top
            ...
            $("#pdf_paid").on("click", function(){
               ...
               window.open('monthlyPaidToPDF.php?department='+department+'&from='+from+'&to='+to+"&departmentText="+departmentText);
            ...
            $(".view_prolongs_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/visits/monthly_prolongs.ajax.php",
					type: "POST",
					data: { department: department, from: from, to: to},
					dataType: "json"
				}).always(function(){
            ...
            var addProlongs = function(results){
                ...
                if (number_of_prolonged_users <= 10) {
                    $.each(rows, function(i, item) {
                        $('.prolonged').find('tbody:last').append("<tr><td>"+rows[i].firstname+"</td><td>"+rows[i].surname+"</td><td>"+moneyFormat(rows[i].count)+"</td><td>"+rows[i].datetime+"</td><td><a href='../../cgi-bin/koha/members/boraccount.pl?borrowernumber="+rows[i].borrowernumber+"' target='_blank'><i class='fa fa-external-link'></i></a></td></tr>");
                    });
                }
                else {
                    // print 10
        ...
        scrollTop: $("#prolonged_names").offset().top
            ...
            $("#pdf_prolonged").on("click", function(){
               ...
               window.open('monthlyProlongedToPDF.php?department='+department+'&from='+from+'&to='+to+"&departmentText="+departmentText);
            ...
            $(".view_virtualProlongs_detail").on("click", function(){
               ...
               $.ajax({
					url: "../system/visits/monthlyVirtualProlongs.ajax.php",
					type: "POST",
					data: { department: department, from: from, to: to},
					dataType: "json"
				}).always(function(){
        ...
        scrollTop: $("#virtualProlonged_names").offset().top
            ...
            $("#pdf_virtualProlonged").on("click", function(){
               ...
               window.open('monthlyVirtualProlongedToPDF.php?department='+department+'&from='+from+'&to='+to+"&departmentText="+departmentText);
             ...
             $("#pdf_monthly").on("click", function(){
               ...
               window.open('monthlyPDF.php?department='+department+'&from='+from+'&to='+to+"&departmentText="+departmentText+"&total="+total+"&registrations="+registrations+"&borrows="+borrows+"&reservations="+reservations+"&returns="+returns+"&paids="+paids+"&prolongs="+prolongs);
