...
# along with Koha; if not, see <http://www.gnu.org/licenses>.
    ...
    $registrations = (int) $_GET["registrations"];
    $borrows = (int) $_GET["borrows"];
    $reservations = (int) $_GET["reservations"];
    $returns = (int) $_GET["returns"];
    $paids = (int) $_GET["paids"];
    $prolongs = (int) $_GET["prolongs"];
...
$html = "
<h3>$text->visits_summary ($day) - $departmentText</h3>
   <table>
